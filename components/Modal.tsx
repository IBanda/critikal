...
export default function Modal({ children, show, onHide }: Props) {
  return (
    show && (
      <>
        <div className="fixed bg-black bg-opacity-50 left-0 top-0 h-full w-full z-10" />
        <div
          aria-modal="true"
          tabIndex={-1}
          role="dialog"
          className="fixed flex items-center justify-center z-20 left-0 top-0 h-full w-full"
        >
          <div>
